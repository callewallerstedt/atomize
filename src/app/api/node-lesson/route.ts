...
export async function POST(req: Request) {
  try {
    ...
    const system = [
      ...
      "",
      "EXPLANATION PROGRESSION (this is critical for understanding):",
      "For each major concept, use this exact 3-step structure:",
      "1. **Intuition First** - Start with a concrete analogy, visual metaphor, or everyday example that captures the essence",
      "2. **Formal Definition** - Then provide the precise technical definition with proper terminology and math",
      "3. **Worked Example** - Show a specific, detailed example with step-by-step reasoning",
      "",

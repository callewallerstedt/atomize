...
export default function GlowSpinner({
  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" role="img" aria-label={ariaLabel} width={w} height={h} overflow="visible" style={{ overflow: "visible" }}>
        <defs>
          ...
          <filter id={idBlurSoft} filterUnits="userSpaceOnUse" x="-400" y="-400" width="1000" height="1000">
            <feGaussianBlur stdDeviation="4" edgeMode="duplicate" />
          </filter>
          <filter id={idBlurWide} filterUnits="userSpaceOnUse" x="-400" y="-400" width="1000" height="1000">
